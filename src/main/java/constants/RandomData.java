...
public class RandomData {
  ...
  public static final String RANDOM_LOGIN = RandomStringUtils.randomAlphabetic(3);
  ...
  public static final int RANDOM_ORDER_TRACK = Integer.parseInt(RandomStringUtils.randomNumeric(4));
  public static final String RANDOM_ORDER_ID = RandomStringUtils.randomNumeric(7);
}
